...
public class PlaylistSearch {
    ...
    @JsonProperty("list")
    public void setLists(ArrayList<Playlist> list) {
        this.list = list;
    }
    ...
    public String toString() {
        ...
        sb.append(PlaylistSearch.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("page");
        sb.append('=');
